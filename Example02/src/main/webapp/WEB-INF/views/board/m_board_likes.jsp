...
<title>${user.id}님이 좋아한 게시물</title>
</head>
<body>
	<div class="allcontainer">
		...
		<section class="content">
			...
			<div class="profile-tab">
				<ul>
					<li class="tab-link" data-tab="tab-1"><a href="${pageContext.request.contextPath}/${user.id}/profile">ALL</a></li>
					...
					<li class="tab-link current" data-tab="tab-4"><a href="${pageContext.request.contextPath}/${user.id}/profile/likes"><i class="fas fa-heart fa-2x"></i></a></li>
				</ul>
			</div>
