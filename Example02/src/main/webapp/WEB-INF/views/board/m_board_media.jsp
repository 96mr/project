		...
		<section class="content">
			...
			<div class="profile-tab">
				<ul>
					...
					<li class="tab-link current" data-tab="tab-3"><a href="${pageContext.request.contextPath}/${user.id}/profile/media"><i class="far fa-image fa-2x"></i></a></li>
